...
The `number of followers` of users in Mauritania on `2025/2/21 2:26 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
