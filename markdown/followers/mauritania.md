...
The `number of followers` of users in Mauritania on `2025/2/22 5:32 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
