...
The `number of followers` of users in Mauritania on `2025/2/13 3:51 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
