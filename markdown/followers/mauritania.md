...
The `number of followers` of users in Mauritania on `2025/2/27 1:52 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.
