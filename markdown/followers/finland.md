...
The `number of followers` of users in Finland on `2025/3/6 7:50 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
