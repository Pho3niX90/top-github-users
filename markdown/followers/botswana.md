...
The `number of followers` of users in Botswana on `2025/2/18 3:17 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
