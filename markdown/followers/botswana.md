...
The `number of followers` of users in Botswana on `2025/2/24 2:04 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
