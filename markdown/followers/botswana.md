...
The `number of followers` of users in Botswana on `2025/3/11 8:49 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.
