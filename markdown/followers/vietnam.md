...
The `number of followers` of users in Vietnam on `2025/2/22 2:38 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `911 users`  in Vietnam. You need at least `36 followers` to be on this list.
