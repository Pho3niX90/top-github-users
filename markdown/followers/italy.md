...
The `number of followers` of users in Italy on `2025/2/15 10:34 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `949 users`  in Italy. You need at least `85 followers` to be on this list.
