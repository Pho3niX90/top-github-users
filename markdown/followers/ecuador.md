...
The `number of followers` of users in Ecuador on `2025/2/20 2:14 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.
