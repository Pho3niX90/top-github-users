...
The `number of followers` of users in Nicaragua on `2025/2/28 8:40 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.
