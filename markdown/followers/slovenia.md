...
The `number of followers` of users in Slovenia on `2025/3/10 10:35 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `921 users`  in Slovenia. You need at least `7 followers` to be on this list.
