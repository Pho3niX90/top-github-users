...
The `number of followers` of users in Slovenia on `2025/3/7 10:51 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.
