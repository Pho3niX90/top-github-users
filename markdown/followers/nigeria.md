...
The `number of followers` of users in Nigeria on `2025/3/10 6:10 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `854 users`  in Nigeria. You need at least `77 followers` to be on this list.
