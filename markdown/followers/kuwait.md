...
The `number of followers` of users in Kuwait on `2025/2/16 3:43 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.
