...
The `number of followers` of users in Colombia on `2025/2/15 4:46 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
