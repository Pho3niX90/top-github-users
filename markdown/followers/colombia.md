...
The `number of followers` of users in Colombia on `2025/2/10 8:23 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
