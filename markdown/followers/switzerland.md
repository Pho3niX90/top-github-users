...
The `number of followers` of users in Switzerland on `2025/2/11 3:24 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
