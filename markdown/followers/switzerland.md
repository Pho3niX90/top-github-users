...
The `number of followers` of users in Switzerland on `2025/3/3 1:09 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
