...
The `number of followers` of users in Switzerland on `2025/2/26 4:55 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.
