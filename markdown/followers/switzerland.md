...
The `number of followers` of users in Switzerland on `2025/2/18 8:24 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `751 users`  in Switzerland. You need at least `101 followers` to be on this list.
