...
The `number of followers` of users in Venezuela on `2025/3/8 6:39 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
