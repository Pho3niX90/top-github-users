...
The `number of followers` of users in Venezuela on `2025/2/25 2:23 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
