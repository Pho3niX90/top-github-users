...
The `number of followers` of users in Venezuela on `2025/2/24 9:41 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
