...
The `number of followers` of users in Bulgaria on `2025/3/2 3:32 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
