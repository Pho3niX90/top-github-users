...
The `number of followers` of users in Kenya on `2025/3/1 8:21 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
