...
The `number of followers` of users in Kenya on `2025/2/26 5:58 AM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.
