...
The `number of followers` of users in Kenya on `2025/2/10 3:34 PM UTC`. This list contains users from `Kenya` and cities `Nairobi` `Mombasa` `Kisumu` `Nakuru` `Eldoret`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `765 users`  in Kenya. You need at least `75 followers` to be on this list.
