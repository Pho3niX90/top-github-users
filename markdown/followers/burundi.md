...
The `number of followers` of users in Burundi on `2025/2/23 10:52 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.
