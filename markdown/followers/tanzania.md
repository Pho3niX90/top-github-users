...
The `number of followers` of users in Tanzania on `2025/2/13 1:07 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.
