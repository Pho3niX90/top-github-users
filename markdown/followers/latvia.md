...
The `number of followers` of users in Latvia on `2025/3/9 9:39 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `808 users`  in Latvia. You need at least `7 followers` to be on this list.
