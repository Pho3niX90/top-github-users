...
The `number of followers` of users in Belarus on `2025/2/19 7:38 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.
