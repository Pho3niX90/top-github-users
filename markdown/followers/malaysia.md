...
The `number of followers` of users in Malaysia on `2025/2/13 3:23 AM UTC`. This list contains users from `Malaysia` and cities `Kuala-lumpur` `Malacca-city` `Kuching` `Ipoh` `Johor-bahru`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `862 users`  in Malaysia. You need at least `23 followers` to be on this list.
