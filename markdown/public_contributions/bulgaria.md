...
The `public contributions` by users in Bulgaria on `2025/2/23 10:41 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.
