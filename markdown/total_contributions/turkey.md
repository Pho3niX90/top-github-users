...
The `public contributions` and `private contributions` by users in Turkey on `2025/2/23 4:09 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
