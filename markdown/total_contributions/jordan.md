...
The `public contributions` and `private contributions` by users in Jordan on `2025/2/10 3:07 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
