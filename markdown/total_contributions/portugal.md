...
The `public contributions` and `private contributions` by users in Portugal on `2025/3/9 3:39 PM UTC`. This list contains users from `Portugal` and cities `Lisbon` `Porto` `Braga` `Coimbra`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `766 users`  in Portugal. You need at least `83 followers` to be on this list.
