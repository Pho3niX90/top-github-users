...
The `public contributions` and `private contributions` by users in Kazakhstan on `2025/2/23 6:50 PM UTC`. This list contains users from `Kazakhstan` and cities `Almaty` `Shymkent` `Karagandy` `Taraz` `Nursultan` `Pavlodar` `Oskemen` `Semey` `Aktobe` `Kostanay`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/Pho3niX90/top-github-users).

There are `795 users`  in Kazakhstan. You need at least `12 followers` to be on this list.
