...
The `public contributions` and `private contributions` by users in Finland on `2025/2/17 3:59 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.
