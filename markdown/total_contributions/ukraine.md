...
The `public contributions` and `private contributions` by users in Ukraine on `2025/2/13 2:22 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
