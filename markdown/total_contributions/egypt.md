...
The `public contributions` and `private contributions` by users in Egypt on `2025/2/18 7:48 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
